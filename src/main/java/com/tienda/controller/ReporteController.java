...
public class ReporteController {
    ...
    public ResponseEntity<Resource> reporteInventario(
            @RequestParam int existenciaMin,
            @RequestParam int existenciaMax,
            @RequestParam String tipo
    ) throws IOException {
        Map<String, Object> parametros = new HashMap<>();
        parametros.put("existenciaMin", existenciaMin);
        parametros.put("existenciaMax", existenciaMax);
